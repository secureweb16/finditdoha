...
function get_url_contents($url) {
    ...
    curl_setopt($crl, CURLOPT_CONNECTTIMEOUT, 4);
...
{
    //$results[] = array('link' => $result->link, 'alt' => $result->title);
    echo '<li class="imagesharp"><img class="imagelink" src="' . $result->link . '" alt="' . $result->title . '"/></li>';
...
<script>
 ...
 jQuery('.imagelink').error(function() {  
  jQuery(this).parent('li').hide();
});
});

 jQuery('.imagelink').click(function (e) {
     jQuery('.imagelink.withborder').not(e.target).removeClass('withborder');
    jQuery(this).toggleClass('withborder');
     jQuery('.hiddenvalue').val(this.src);	
});
